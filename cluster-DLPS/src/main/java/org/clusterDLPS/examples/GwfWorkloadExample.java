 ...
 */
package org.clusterDLPS.examples;
 ...
 */
public class GwfWorkloadExample {
    /**
     ...
     */
    private int maximumNumberOfCloudletsToCreateFromTheWorkloadFile = 1000;
    ...
    public static void main(String[] args) {
        new GwfWorkloadExample();
    }

    private GwfWorkloadExample() {
